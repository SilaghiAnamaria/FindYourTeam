...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    // why might instanceId not be in the store? an event from another calendarapp?
    ...
    */
    ...
    onto a calendarapp. Contains information for creating an event.
    */
    ...
    */
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            // allow (a function)
            var calendarEventStore = currentState.eventStore; // need global-to-calendarapp, not local to component (splittable)state
            for (var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++) {
                ...
                var eventApi = void 0;
                if (origDef) { // was previously in the calendarapp
    ...
    */
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleDragEnd = function (ev) {
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        // dropped within same calendarapp
                        if (receivingContext_1 === initialContext_1) {
                            ...
                            // dropped in different calendarapp
                        }
        ...
        EventDragging.prototype.displayDrag = function (nextContext, state) {
            ...
            // does the previous calendarapp need to be cleared?
            if (prevContext && prevContext !== nextContext) {
                // does the initial calendarapp need to be cleared?
                ...
                if (prevContext === initialContext) {
                    ...
                    // completely clear the old calendarapp if it wasn't the initial
                }
                else {
        ...
        EventDragging.prototype.clearDrag = function () {
            ...
            // the initial calendarapp might have an dummy drag state from displayDrag
    ...
    of a calendarapp onto a calendarapp.
    */
    ...
    /*
    Makes an element (that is *external* to any calendarapp) draggable.
    Can pass in data that determines how an event will be created when dropped onto a calendarapp.
    ...
    */
    ...
    function parseGoogleCalendarId(url) {
        ...
        // will match calendars like "asdf1234@calendarapp.google.com" in addition to person email calendars.
